...
export default function SignupPage() {
  return (
    <main className="bg-auth-gradient relative min-h-screen overflow-hidden p-6">
      <div
        aria-hidden
        className="pointer-events-none absolute -top-32 -right-32 size-80 rounded-full bg-primary/10 blur-3xl"
      />
      <div
        aria-hidden
        className="pointer-events-none absolute -bottom-32 -left-32 size-96 rounded-full bg-emerald-500/10 blur-3xl"
      />
